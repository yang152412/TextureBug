...
- (void)loadData
{
  ...
  for (NSInteger s = 0; s < 100; s++) {
    ...
    [data insertObject:[NSMutableArray arrayWithObjects:@"https://ddimg.ddxq.mobi/d4e8be34f3c7581529484049901.gif", nil] atIndex:0];
//  [data insertObject:[NSMutableArray arrayWithObjects:@"https://ddimg.ddxq.mobi/3e8ebfff1512011026044.gif", nil] atIndex:0];
  [data insertObject:[NSMutableArray arrayWithObjects:@"http://img.zcool.cn/community/015ed7587b2407a801219c77e71d81.gif", nil] atIndex:0];
  self.data = data;
}
